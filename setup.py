...
# Package meta-data.
NAME = "pytorch_transformer_ts"
DESCRIPTION = "PyTorch Transformer TS"
...
with open(ROOT / "pytorch_transformer_ts" / "version.py") as version_file:
...
setup(
    ...
    packages=["pytorch_transformer_ts"],  # find_packages(exclude=["tests", "*.tests", "*.tests.*", "tests.*"]),
